...
class WordlistPolicy
{
     ...
     */
    public function view(User $user, Wordlist $wordlist): bool
    {
     ...
     */
    public function update(User $user, Wordlist $wordlist): bool
    {
     ...
     */
    public function delete(User $user, Wordlist $wordlist): bool
    {
     ...
     */
    public function restore(User $user, Wordlist $wordlist): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, Wordlist $wordlist): bool
    {
        return false;
    }
}
