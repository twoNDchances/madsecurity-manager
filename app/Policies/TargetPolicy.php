...
class TargetPolicy
{
    ...
    {
        return IdentificationService::can($user, 'policy', $action);
    }
    ...
    {
        return $this->getResource($user, 'update') && !$target->immutable;
    }
    ...
    {
        return $this->getResource($user, 'delete') && !$target->immutable;
    }
